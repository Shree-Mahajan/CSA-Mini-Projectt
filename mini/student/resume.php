		...
		<table width="100%" cellpadding="5px">
			<div>														<!-- first -->
				<tr style="height:200px">
					<td style="width: 14%;" id="photo">PHOTO</td>
					<td colspan="2" style="width: 75%;padding: 0px"><img src="../mitlogo.png" width="70%"></td>
					<td style="width: 14%"><?php echo $prn ?></td>
				</tr>
				<tr>
					<th>Name:</th>
				...
				<tr>
					...
					<td colspan="3">Live: <?php echo $latkt ?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Dead:<?php echo $datkt ?></td>
				</tr>
			</div>
			
			<div>													<!-- objective -->
			<tr>
				<th colspan="4" class="title" style="background-color: #92C4E3">Objective</th>
			</tr>
			<tr>
			...
			<div>														<!-- Educational details -->
				<tr>
					<th colspan=4 class="title" style="background-color: #92C4E3">Educational details:</th>
				</tr> 
				<tr>
			...
			<div>														<!-- Technical Knowledge -->
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Technical Skills</th>
				</tr>
				<tr>
					<td colspan="4" >	
			...
			<div>														<!-- Tools-->
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Tools</th>
				</tr>
				<tr>
					<td colspan="4" >	
			...
			<div>														<!-- Platform-->
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Platform / OS</th>
				</tr>
				<tr>
					<td colspan="4" >
			...
			<div>														<!-- SOI-->
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Subject of Interest</th>
				</tr>
				<tr>
					<td colspan="4" >
			...
			<div>														<!-- Internship -->
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Internship</th>
				</tr>
				<tr>
					<th>Company</th>
			...
			<div>															<!-- projects -->
				<tr>
					<th colspan="4"  class="title" style="background-color: #92C4E3">Projects</th>
				</tr>
				<tr>
			...
			<div>															<!-- certification -->
				<?php 
					...
					{?>
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Certification / Online Courses</th>
				</tr>		
			...
			<div>															<!-- Achievements -->
				<?php 
					...
					{?>
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Achievements</th>
				</tr>
					<?php	while ($row=mysqli_fetch_assoc($result)) {
							echo "<tr><td colspan='4'>".$row['description']."</td></tr>";
						}
			...
			<div>																<!-- conference -->
				<?php 
					...
					{?>
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Conference / Workshop</th>
				</tr>
					<?php	while ($row=mysqli_fetch_assoc($result)) {
							echo "<tr><td colspan='4'>".$row['description']."</td></tr>";
						}
			...
			<div>																<!-- hobbies -->
				<?php if ($hobbie!='') {?>
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Hobbies</th>
				</tr>
				<tr>
			...
			<div>	
				...
				<tr>
					<th colspan="4" class="title" style="background-color: #92C4E3">Language preference</th>
				</tr>
				<tr>
